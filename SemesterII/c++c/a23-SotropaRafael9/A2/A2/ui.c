...
int readIntegerNumber(const char* message)
{
    ...
    {
        printf(message);
        int scanf_result = scanf_s("%15s", s);

        r = scanf_s(s, "%d", &res);	// reads data from s and stores them as integer, if possible; returns 1 if successful
        flag = (r == 1);
        if (flag == 0)
...
int addUI(UI* ui, UndoRedo* ur)
{
    ...
    printf("Quantity: ");
    scanfResult = scanf_s("%d", &quantity);

    printf("Date: ");
    scanfResult = scanf_s("%d", &date);
...
int updateUI(UI* ui, UndoRedo* ur)
{
    ...
    printf("Quantity: ");
    scanfResult = scanf_s("%d", &newQuantity);

    printf("Date: ");
    scanfResult = scanf_s("%d", &newDate);
...
int listSearchProductByCategory(UI* ui)
{
    ...
    scanfResult = scanf_s("%d", &expirationDate);

    printf("X days close to the expiration date: ");
    scanfResult = scanf_s("%d", &x);

    printf("Ascending: 1, Descending: 2");
    scanfResult = scanf_s("%d", &sorted);
