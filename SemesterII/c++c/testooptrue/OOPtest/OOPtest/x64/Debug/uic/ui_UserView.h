...
public:
    ...
    void setupUi(QMainWindow *UserViewClass)
    {
        ...
        chatLine->setGeometry(QRect(300, 220, 181, 22));
        sendButton = new QPushButton(centralWidget);
        sendButton->setObjectName("sendButton");
        sendButton->setGeometry(QRect(490, 220, 71, 24));
        descLine = new QLineEdit(centralWidget);
        descLine->setObjectName("descLine");
        descLine->setGeometry(QRect(60, 290, 113, 22));
        latLine = new QLineEdit(centralWidget);
        latLine->setObjectName("latLine");
        latLine->setGeometry(QRect(190, 290, 113, 22));
        longLine = new QLineEdit(centralWidget);
        longLine->setObjectName("longLine");
        longLine->setGeometry(QRect(320, 290, 113, 22));
        label_4 = new QLabel(centralWidget);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(80, 320, 71, 16));
        label_5 = new QLabel(centralWidget);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(220, 320, 49, 16));
        label_6 = new QLabel(centralWidget);
        label_6->setObjectName("label_6");
        label_6->setGeometry(QRect(340, 320, 81, 16));
        addButton = new QPushButton(centralWidget);
        addButton->setObjectName("addButton");
        addButton->setGeometry(QRect(450, 290, 75, 24));
        widget = new QWidget(centralWidget);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(10, 210, 116, 68));
